...
public class Game {
    public static void main(String[] args) {
        ...
        Robot playerBot = new Robot(1, 1, username, 'O');
                ...
                do {
                    ...
                    relPos = getRelPos(direction);
                        ...
                        !"wasd".contains(direction + "") ||
                                !isSpaceAvailable(relPos[0] + playerBot.getX(), relPos[1] + playerBot.getY(), playfield, robots)
                );
    ...
    public static boolean isSpaceAvailable(int x, int y, Playfield playfield, Robot[] robots) {
        return !(
            x < 0 ||
            y < 0 ||
